...
function encodeDownlink(input) {
    ...
    if (input.data.Cmd == "ConfigReportReq") {
        ...
        var batt = input.data.BatteryChange * 10;
        ret = ret.concat(getCmdID, devid, (mint >> 8), (mint & 0xFF), (maxt >> 8), (maxt & 0xFF), batt, 0x00, 0x00, 0x00, 0x00);
